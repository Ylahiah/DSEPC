...
files = {
    "workbook": ("Ejercicio práctico Excel (Captura)lite.xlsx", base_excel, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"),
    "solution_workbook": ("Ejercicio práctico Excel (Resuelto)lite.xlsx", sol_excel, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
}

data = {
    "name": "Test Exact Frontend",
    "description": "Caso practico",
    "instructions": "Sigue las instrucciones",
